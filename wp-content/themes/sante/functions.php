...
function twentysixteen_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Marketplace Solutions', 'twentysixteen' ),
		'id'            => 'marketplace-solutions',
		'description'   => __( 'Appears After the header banner at home page.', 'twentysixteen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
	...
	register_sidebar( array(
		...
		'description'   => __( 'Appears at the footer left sante block.', 'twentysixteen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
	...
	register_sidebar( array(
		'name'          => __( 'Reach Us', 'twentysixteen' ),
		'id'            => 'reach-us',
		'description'   => __( 'Appears at the footer right block.', 'twentysixteen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
	...
	register_sidebar( array(
		...
		'id'            => 'footer-copyright',
		'description'   => __( 'Appears at the footer.', 'twentysixteen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
